...
pdf_documents = [('index', u'django-robohash-svg_pdf', u'django-robohash-svg', u'Eric Lapouyade'),]
...
latex_documents = [
  ('index', 'django-robohash-svg.tex', u'django-robohash-svg Documentation',
...
man_pages = [
    ('index', 'django-robohash-svg', u'django-robohash-svg Documentation',
     [u'Eric Lapouyade'], 1)
]
...
texinfo_documents = [
  ('index', 'django-robohash-svg', u'django-robohash-svg Documentation',
   u'Eric Lapouyade', 'best-templatetags', 'django-robohash-svg library.',
   'Miscellaneous'),
]
